...
def main():
    ...
    parser.add_argument('--test_step',  type=int,   default=100,       help='Test and save every [test_step] epochs')
    ...
    parser.add_argument('--train_list', type=str,   default= "/Users/maryamafshari/Desktop/Thesis_data/train_list_very_small.txt",     help='The path of the training list, https://www.robots.ox.ac.uk/~vgg/data/voxceleb/meta/train_list.txt')
    ...
    parser.add_argument('--train_path', type=str,   default="/Users/maryamafshari/Desktop/Thesis_data/Voxceleb2_small/Audio/dev/aac",                    help='The path of the training data, eg:"/data08/VoxCeleb2/train/wav" in my case')
