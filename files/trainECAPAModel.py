...
def main():
    ...
    parser.add_argument('--train_path', type=str,   default="/mnt/disk1/data/voxceleb_2/dev/aac",                    help='The path of the training data, eg:"/data08/VoxCeleb2/train/wav" in my case')
